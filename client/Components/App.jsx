...
let axios_url = 'http://localhost:3200'

class App extends React.Component {
  constructor() {
    super();
    this.state = {
      reviewData: [], //all reviews from restaurant
      restaurantData: {} //data of restaurant
    }
  ...
  getReviewsForRestaurantID() {
    ...
    // let {id} = this.state
    axios.get(`${axios_url}/restaurants/psql/reviews/${id}`)
      .then( data => {
